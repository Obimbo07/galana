...
export function WhatsAppFab({
  ...
  if (!configured) {
    return (
      <span
        className="help-fab-wa help-fab-wa-disabled"
        title="Set contact.whatsappDigits in JSON"
        aria-label="WhatsApp unavailable: configure contact.whatsappDigits in site data"
      >
        <WhatsAppMark />
      </span>
    );
