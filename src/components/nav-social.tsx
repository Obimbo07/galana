...
const LABELS: Record<SocialKey, string> = {
  twitter: "Galana on X (Twitter)",
  facebook: "Galana on Facebook",
  linkedin: "Galana on LinkedIn",
  instagram: "Galana on Instagram",
  youtube: "Galana on YouTube",
};
  ...
  return (
    <div className="nav-social">
      {entries.map((key) => (
        <a
          key={key}
          className={`nav-social-link nav-social-link--${key}`}
          href={social[key]}
          target="_blank"
